...
Also, if you use a plugin that handles directory arguments (e.g. file trees/explorers), it may prevent AutoSession from loading or saving sessions when launched with a directory argument. You can avoid that by lazy loading that plugin (e.g. [Oil](https://github.com/rmagatti/auto-session/issues/372#issuecomment-2471077783), [NvimTree](https://github.com/rmagatti/auto-session/issues/393#issuecomment-2474797271)) or you can [add `priority = 500,` to your AutoSession config in Lazy.nvim](https://github.com/rmagatti/auto-session/issues/430#issuecomment-2833514675) to make sure AutoSession loads before most other plugins.
