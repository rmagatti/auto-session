...
---@field single_session_mode? boolean Enable single session mode to keep all work in one session regardless of cwd changes. When enabled, prevents creation of separate sessions for different directories and maintains one unified session. Do not use this with cwd_change_handling
